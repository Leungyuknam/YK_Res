/*******************************************************************************
* 版权所有（C）2019 中微半导体有限公司。保留所有权利。
*
* 本软件由以下公司拥有并发布：
* 中微半导体有限公司，中国深圳市南山区桃园路田厦金牛广场 2609-10。
*
* 下载、安装或使用本软件，即表示您同意受本协议
* 所有条款和条件的约束。
*
* 本软件包含与中微半导体元器件配套使用的源代码。
* 中微半导体仅授权将本软件适配用于
* 采用中微半导体元器件的系统。对于将本软件误用或非法用于
* 本软件未支持器件的行为，中微半导体不承担责任。
* 本软件按“现状”提供，对于用户错误实施
* 本软件所产生的问题，中微半导体
* 不承担责任。
*
* 为获授权的用途，可以复制本软件的部分或全部内容，
* 但无论使用部分还是全部内容，每份副本均必须
* 始终包含本免责声明和版权声明。
*
*/
 ...
 **GPIO引脚
 ---------------------------------------------------------------------------*/
#define  GPIO_PIN_0_MSK				(0x01)		/* GPIO 0 号引脚掩码 */
#define  GPIO_PIN_1_MSK				(0x02)		/* GPIO 1 号引脚掩码 */
#define  GPIO_PIN_2_MSK				(0x04)		/* GPIO 2 号引脚掩码 */
#define  GPIO_PIN_3_MSK				(0x08)		/* GPIO 3 号引脚掩码 */
#define  GPIO_PIN_4_MSK				(0x10)		/* GPIO 4 号引脚掩码 */
#define  GPIO_PIN_5_MSK				(0x20)		/* GPIO 5 号引脚掩码 */
#define  GPIO_PIN_6_MSK				(0x40)		/* GPIO 6 号引脚掩码 */
#define  GPIO_PIN_7_MSK				(0x80)		/* GPIO 7 号引脚掩码 */

#define  GPIO_PIN_0					(0x00)		/* GPIO 0 号引脚编号*/
#define  GPIO_PIN_1					(0x01)		/* GPIO 1 号引脚编号 */
#define  GPIO_PIN_2					(0x02)		/* GPIO 2 号引脚编号 */
#define  GPIO_PIN_3					(0x03)		/* GPIO 3 号引脚编号 */
#define  GPIO_PIN_4					(0x04)		/* GPIO 4 号引脚编号 */
#define  GPIO_PIN_5					(0x05)		/* GPIO 5 号引脚编号 */
#define  GPIO_PIN_6					(0x06)		/* GPIO 6 号引脚编号 */
#define  GPIO_PIN_7					(0x07)		/* GPIO 7 号引脚编号 */
...
/*****************************************************************************/
/* 全局变量声明（'extern'，在 C 源文件中定义）*/
/*****************************************************************************/

/*****************************************************************************/
/* 全局函数原型（'extern'，在 C 源文件中定义）*/
/*****************************************************************************/

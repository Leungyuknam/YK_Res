...
#define	TCNT_RESET()		{B_Bright_500MS = 1;B_Bright_1S = 0;B_Bright_OFF_1S = 0;g_u8Bright_500MS_Cnt = 0;}
#define	KEY_NUM_EFF()		{B_Bright_500MS = 1;B_Bright_1S = 0;B_Bright_OFF_1S = 0;g_u8Bright_500MS_Cnt = 0;}

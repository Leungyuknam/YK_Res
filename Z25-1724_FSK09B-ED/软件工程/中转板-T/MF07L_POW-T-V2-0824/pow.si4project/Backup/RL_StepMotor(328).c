...
/******************************************************************
 ...
 输出参数：						无
*******************************************************************/
void F_RL_StepMotorRstInit(void)//风门复位启动--初始复位角度和当前角度值
{	
	r_RL_SMAngleNow = 0;		
	r_RL_SMAngleSet = c_RL_AngleRst;
}
...
void F_RL_StepMotorRstControl(void)//步进电机控制=
{
	...
	{	
		F_RL_StepMotorRstInit();
		g_u8RL_SMRstState = Rst_Ing;
	}
	//else if(Rst_Need2 == g_u8RL_SMRstState)
	//{
	//	F_RL_StepMotorFixed(c_RL_AngleInit, c_RL_SMSpeedRst);
	//	g_u8RL_SMRstState = Rst_Ing2;
	//}

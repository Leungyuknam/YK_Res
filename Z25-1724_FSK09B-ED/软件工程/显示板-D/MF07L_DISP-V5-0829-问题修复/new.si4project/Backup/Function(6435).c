...
u8 code TempGoalTab[] ={  								
	...
	//	60, 		80, 		110,		120,		140 ,		160,		180,		200,		220,			240    温度
		TE_40,  	TE_45,  	TE_50,  	TE_59,  	TE_63,  	TE_67, 		TE_73, 		TE_78,		TE_83,			TE_93//TE_88//TE_98 
};
...
//	MENU_NONE		HUOGUO		ZHENGZHU	MENGZHU		JIANKAO		BAOTANG		MANDUN
//	146,			146,		146,		146,		250,		146,		146
	156,			156,		156,		156,		250,		156,		156
...
u8 DriveControDeal(u8 NowTempDat)
{
	...
	switch(sHeat.HeatStep)
	{
		...
		case 2:
				...
				HeatLevel = Drive_Heat_Control(NowTempDat,GoalTempAD,9,3,16,0,100,30,&sHeat); //12 50  //100 40
				#else

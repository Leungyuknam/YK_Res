...
#define BELL_NOR()        				BeepSet(3,50,50,BUZZ_NOR)		//有效按键音
#define	BELL_OFF()						BeepSet(3,50,50,BUZZ_NOR)				//关机音
#define	BELL_ON()						BeepSet(3,50,50,BUZZ_NOR)				//开机音
#define	BELL_WARN()						BeepSet(3,50,50,BUZZ_NOR)
#define	BELL_PAUSE()					BeepSet(3,50,50,BUZZ_NOR)	
#define	BELL_START()					BeepSet(3,50,50,BUZZ_NOR)	

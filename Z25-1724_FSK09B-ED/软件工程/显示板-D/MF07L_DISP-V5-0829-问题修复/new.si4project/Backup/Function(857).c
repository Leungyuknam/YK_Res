...
u8 code TempGoalTab[] ={  								
	...
	//	60, 		80, 		110,		120,		140 ,		160,		180,		200,		220,			240    温度
		TE_40,  	TE_45,  	TE_50,  	TE_59,  	TE_63,  	TE_67, 		TE_73, 		TE_78,		TE_83,			TE_88//TE_98 
};
...
u8 code LeveLMaxTab[] ={  
	//	L1			L2			L3			L4			L5			L6			L7			L8			L9				L10	
	//	60, 		80, 		110,		120,		140 ,		160,		180,		200,		220,			240    温度
		HL_4,  		HL_4, 		HL_4,  		HL_5,  		HL_5,  		HL_6, 		HL_6, 		HL_6,		HL_7,			HL_7   
};
...
u8 DriveControDeal(u8 NowTempDat)
{
	...
	switch(sHeat.HeatStep)
	{
		...
		case 1:
			...
			else
			{
				...
				*/
				...
				else if(sHeat.KeepPowSec < 6*60 && NowTempDat < 130)
				{
					u8temp0 = 22;
				}
				else if(sHeat.KeepPowSec < 8*60 && NowTempDat < 160)
				{
					u8temp0 = 30;
				}
				else 
		...
		case 2:
				...
				HeatLevel = HeatControl(NowTempDat,GoalTempAD,6,0,8,3,&sHeat);  //6  //3

...
static void F_DispNormal(void)
{
	...
	if((Sys.MState != COOK_NONE) && ((Flag1_Error || Flag2_Error) || !(Status2_Work & 0x20) || Sys.Sign.NoPot))
	{
...
//	static u8 DisplayStepTest = 0;
	...
	if((COOK_RUN_PAUSE == Sys.MState) && !Flag1_Error && !Flag2_Error && ((Status2_Work & 0x20) || Sys.Sign.NoPot))
	{ 

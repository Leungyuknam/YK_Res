...
#define	COM1_ON()		{P2CON |= BIT6;COM1 = COM_ON;}
#define	COM2_ON()		{P1CON |= BIT1;COM2 = COM_ON;}
#define	COM3_ON()		{P0CON |= BIT0;COM3 = COM_ON;}
#define	COM4_ON()		{P0CON |= BIT2;COM4 = COM_ON;}
//#define	COM5_ON()		{P5CON |= BIT1;COM5 = COM_ON;}
//#define	COM6_ON()		{P2CON |= BIT7;COM6 = COM_ON;}
//#define	COM7_ON()		{P2CON |= BIT6;COM7 = COM_ON;}
	  
#define	All_COM_OFF() 		{P0CON &= ~(BIT0+BIT2);P1CON &= ~BIT1;P2CON &= ~BIT6;}
...
EXT_DISPDR void DispLedBufSet(u8 *u16Buf);

...
u8 code TempGoalTab[] ={  								
	...
	//	60, 		80, 		110,		120,		140 ,		160,		180,		200,		220,			240    温度
		TE_40,  	TE_45,  	TE_51,  	TE_57,  	TE_62,  	TE_68, 		TE_73, 		TE_79,		TE_85,			TE_92 
};
...
u8 code LeveLMaxTab[] ={  
	//	L1			L2			L3			L4			L5			L6			L7			L8			L9				L10	
	//	60, 		80, 		110,		120,		140 ,		160,		180,		200,		220,			240    温度
		HL_4,  		HL_4, 		HL_4,  		HL_5,  		HL_5,  		HL_5, 		HL_5, 		HL_7,		HL_7,			HL_7   
};
...
u16 DriveControDeal(u8 NowTempDat)
{
	...
	switch(sHeat.HeatStep)
	{
		...
		case 1:
			...
			else
			{
				if(sHeat.KeepPowSec >= HEAT_KEEP_TIME)
				{
					...
					u8tempDiff = GoalTempAD - NowTempDat;
					if((sHeat.IncSec > 10)	&& (NowTempDat > (sHeat.RecordTempDat + 5)))
					{
						sHeat.IncSec = 0;
						sHeat.RecordTempDat = NowTempDat;
						HeatLevel = 0;	
		...
		case 2:
			...
			//2,0,4,4,9,16,&sHeat); 
			Drive_Heat_Control(NowTempDat,GoalTempAD,2,0,4,4,5,12,&sHeat);  
...
code MenuHeat_Str MenuCookDeal[3] = { 
	{190, 3*MINT, 10*MINT,			POW_P4,	POW_P6,	4*MINT,	40*MINT,	POW_P4,	60*MINT,	POW_P3, 90*MINT,		POW_P3},		//MENGZHU 	
	{190, 3*MINT, 10*MINT,			POW_P4,	POW_P5,	2*MINT,	45*MINT,	POW_P3,	90*MINT,	POW_P2, 0xffff,			POW_P3}, 		//BAOTANG 	
	{190, 3*MINT, 10*MINT,			POW_P4,	POW_P4,	2*MINT,	30*MINT,	POW_P3,	60*MINT,	POW_P3, 180*MINT,		POW_P2},		//MANDUN		
};

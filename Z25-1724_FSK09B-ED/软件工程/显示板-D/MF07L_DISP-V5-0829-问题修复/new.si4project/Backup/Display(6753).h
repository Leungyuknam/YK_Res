...
#define	DISP_COM_LENGTH 	8 //同驱动显示个数
	...
	EXT_DISP  u16 g_u16DispSegBuf[DISP_COM_LENGTH];
	EXT_DISP I_REG u8 g_u8DispSeg[14];
	EXT_DISP Out_Enum I_REG mPowLedEn = {0};
	...
	EXT_DISP  u16 g_u16DispSegBuf[DISP_COM_LENGTH];
	EXT_DISP I_REG u8 g_u8DispSeg[14];
	EXT_DISP Out_Enum I_REG mPowLedEn;
	EXT_DISP I_REG  DispFlag DispFg;
	//产测

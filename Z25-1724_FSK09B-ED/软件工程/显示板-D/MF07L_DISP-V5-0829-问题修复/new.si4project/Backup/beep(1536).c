...
void F_FrequencyInit(unsigned int Freq)//修改为定时器模拟PWM
{
    ...
    PWMDTYB|=temp<<4;          ////PWM3/4/5周期与占空比的低2位设置  
    PWMDTY5=Duty_num>>2;    ////占空比SET  高8位   
	PWM_ON(); 			//打开频率输出
}
...
code unsigned int FrequencyTable[c_BUZZER_ALL_TYPE][c_MAX_BUZZER_TIMES] = {	//配置蜂鸣器鸣叫类型及次数
    ...
    {C_Voice_5,	C_Voice_5,	C_Voice_End,    C_Voice_End,C_Voice_End,},
    
    {C_Voice_5,	C_Voice_3,	C_Voice_1,      C_Voice_End,C_Voice_End,},
    {C_Voice_3,	C_Voice_End,C_Voice_End,    C_Voice_End,C_Voice_End,},
...
////20ms
code unsigned char NotePowerRingCntTab[] = {
	4,
	2,
	1,
	3,
...
code unsigned char NotePowerOnOffTime[c_BUZZER_ALL_TYPE][c_MAX_BUZZER_TIMES][2] = {	//配置蜂鸣器鸣叫时间以及间隔时间
	{	{4,6},		{5,6},		{5,6},  	{5,22},  	{0,0}	},	//开机		M_POW_ON
	{	{4,6},		{5,22},		{0,0},  	{0,0},  	{0,0}	},	//按键音		M_KEY_PRESS 
	{	{5,6},    	{0,0},		{0,0},  	{0,0},  	{0,0}	},	//警报音		M_ERROR
	{	{4,6},		{5,6},		{5,20},  	{0,0},  	{0,0}	},	//开始、启动、确认	M_START
	{	{4,6},		{5,6},		{5,20},  	{0,0},  	{0,0}	},	//暂停		M_PAUSE
	
	{	{4,6},		{5,6},		{5,6},  	{5,22},  	{0,0}	},	//ECO			M_POW_OFF
    {	{4,6},		{5,20},		{0,0},  	{0,0},  	{0,0}	},	//无效按键
    
    {	{3,3},		{0,0},		{0,0},  	{0,0},  	{0,0}	},	//翻面提示			=>应该未使用
    {	{50,0},		{0,0},		{0,0},  	{0,0},  	{0,0}	},	//无效操作			=>应该未使用
...
/////////////////////////////////////////////////////////////////////
	...
	else if( r_BuzzerCount < NotePowerRingCntTab[r_BuzzerType] )
	{

...
#define KEY_LR						BIT6
#define KEY_UP_DN					BIT5
#define KEY_T_OFF					BIT4

#define KEY_DEC  					BIT3
#define KEY_ONOFF 					BIT9
#define KEY_INC						BIT16

#define KEY_T_ON 					BIT17
#define KEY_NATURE					BIT18
#define KEY_SLEEP_WIND				BIT19

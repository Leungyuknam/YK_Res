...
#define	TEMP_CHK_CNT			40//20	// *500MS 判断锅底温度高且温度斜率有升温过程
...
extern u8  HeatControl(u8 nowTemp,u8 GoalTemp,u8 maxTemp,u8 minTemp,u8 openTime,u8 closeTime,OVEN_Str *Fryer);

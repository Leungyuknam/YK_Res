...
//SelectMenu_Enum mMenu;			//当前选择的菜单    	 		//1
//COOKState_Enum	MState; 		//当前烹饪的运行状态				//1
//CookFlag	Fg; 				//位标志状态量		 		//1
//CookSign	Sign;				//位标志状态量 				//1
//u16 CookLevel;					//烹饪功率档位		 		//2
//u32 BookRunSec; 				//烹饪时间Sec				 		//4
//u32 CookRunSec; 				//烹饪时间Sec				 		//4
//u16 TKeepSec;					//计时提醒时间					 		//2
...
void F_ReadFlashData(void)
{
		...
		(FlashSaveBuf[2] == COOK_RUN_PAUSE))
	{
		...
		*((u8 *)&Sys.Fg) &= BIT_BOOK_COOK_T_SIGN;

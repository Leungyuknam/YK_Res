...
void F_IrDataProc()
{
	...
	{	
		if((g_sIrRecData.Bytes.Cmd == 0x7f)
		...
		{	//if(c_ClientCode == g_sIrRecData.Bytes.ClientCode)
			{	if(c_IrShortKey == g_enuIrUpdataFlg)
				{	
					...
					{	if(g_sIrRecData.Bytes.CmdReverse == g_sShortKeyToEvent[l_u8Cnt].KeyCode)
				...
				{	
					...
					{	if(g_sIrRecData.Bytes.CmdReverse == g_sLongKeyToEvent[l_u8Cnt].KeyCode)

...
code	struct	KeyEventDeal  KeyEventDealCode[] = {
//按键码			按键相应时间	     重复响应否  后续再次响应时间 	响应的事件
	{c_LROsc,   	  C_KEY_60MS,		0,				C_KEY_1S5,			&F_RLOSC_AngleKey },
	{c_UDOsc, 		C_KEY_60MS,		0,					C_KEY_1S5,			&F_UpDnOscKey },
	{c_Time, 		C_KEY_60MS,		0,					C_KEY_1S5,			&F_SetTimeOnOff },
	{c_Dec, 		C_KEY_60MS,		0,					C_KEY_1S5,			&F_WingLevelDec },
	{c_Power, 		C_KEY_60MS,		0,					C_KEY_1S5,			&KeyOFFON },
	{c_Inc, 		C_KEY_60MS,		0,					C_KEY_1S5,			&F_WingLevelInc },
	{c_Mode, 		C_KEY_60MS,		0,					C_KEY_1S5,			&F_WingIR },
	{c_Check,		C_KEY_2S,	  0,					C_KEY_1S5,			&KeyFactory	},
 	{0,0,0,0,0} 
};
#define	c_Power		BIT0
#define c_Mode		BIT1

...
#endif
#if defined(SC95F8x2x) || defined(SC95F7x2x) || defined(SC95F8x3x) || defined(SC95F7x3x)
...
void USCI0_ClearFlag(USCI0_Flag_TypeDef USCI0_FLAG)
{
...
#elif defined(SC95F8x2x) || defined(SC95F7x2x) || defined(SC95F8x3x) || defined(SC95F7x3x)
  ...
  else if ((USCI0_FLAG == USCI0_UART_FLAG_TI) || (USCI0_FLAG == USCI0_UART_FLAG_RI))
  {
    ...
    USXCON0 = USXCON0  & 0xFC | USCI0_FLAG; //写1清零
#else

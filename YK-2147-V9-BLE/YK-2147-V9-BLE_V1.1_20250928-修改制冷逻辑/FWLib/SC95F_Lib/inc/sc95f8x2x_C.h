...
C Header file for SC95F867x microcontroller.
...
日期:  2022.10.26
--------------------------------------------------------------------------*/
#ifndef _SC95F867x_H_
#define _SC95F867x_H_
...
*SC95F8675封装未引出的管脚：无
*SC95F8673封装未引出的管脚：无
*SC95F8672封装未引出的管脚：P06/P07
*SC95F8671封装未引出的管脚：P02/P03/P04/P05/P06/P07
***************************************************/
sbit  P07 = P0^7;
sbit  P06 = P0^6;
sbit  P05 = P0^5;
...
*SC95F8675封装未引出的管脚：无
*SC95F8673封装未引出的管脚：无
*SC95F8672封装未引出的管脚：P16/P17
*SC95F8671封装未引出的管脚：P16/P17
***************************************************/
sbit  P17 = P1^7;
sbit  P16 = P1^6;
sbit  P15 = P1^5;
...
*SC95F8675封装未引出的管脚：无
*SC95F8673封装未引出的管脚：无
*SC95F8672封装未引出的管脚：P22/P23
*SC95F8671封装未引出的管脚：P22/P23/P27
***************************************************/
sbit  P27 = P2^7;
sbit  P26 = P2^6;
sbit  P25 = P2^5;
...
/******************* P5 ***************************
*SC95F8675封装未引出的管脚：无
*SC95F8673封装未引出的管脚：P52/P53/P54/P55
*SC95F8672封装未引出的管脚：P5
*SC95F8671封装未引出的管脚：P5
***************************************************/
sbit  P55 = P5^5;
sbit  P54 = P5^4;
sbit  P53 = P5^3;
...
*如若选SC95F8675，则不用调用宏定义。
*****************************************************************************/                                    
#define  SC95F8673_NIO_Init()   {P5CON|=0x3C;}                                         //SC95F8673的未引出来的IO口配置
#define  SC95F8672_NIO_Init()   {P0CON|=0xC0,P1CON|=0xC0,P2CON|=0X0C,P5CON|=0x3F;}     //SC95F8672的未引出来的IO口配置
#define  SC95F8671_NIO_Init()   {P0CON|=0xFC,P1CON|=0xC0,P2CON|=0X8C,P5CON|=0x3F;}     //SC95F8671的未引出来的IO口配置
#endif
...
//时间片判断
#define		TEST_10MS_FLAG		_BTS(g_u8SysTimeBuff,C_SYS_10MS_)
#define		TEST_50MS_FLAG		_BTS(g_u8SysTimeBuff,C_SYS_50MS_)
#define		TEST_100MS_FLAG		_BTS(g_u8SysTimeBuff,C_SYS_100MS_)
#define		TEST_500MS_FLAG		_BTS(g_u8SysTimeBuff,C_SYS_500MS_)
#define		TEST_1S_FLAG		_BTS(g_u8SysTimeBuff,C_SYS_1S_)
#define		TEST_3S_FLAG		_BTS(g_u8SysTimeBuff,C_SYS_3S_)
#define		TEST_5S_FLAG		_BTS(g_u8SysTimeBuff,C_SYS_5S_)

//外部变量声明
extern  	bit			g_bFlash1HzFlag;
extern  	bit			g_bFlash2HzFlag;
extern  	bit			g_bTimeFlag_2ms;
extern  	u8			g_u8SysTimeBuff;
extern  	u8	xdata	g_u8RunTime100mS;

//函数声明
extern void F_TIME_Event(void);
extern void F_Delay_Us(u8 u8InputDelayTime);    //微秒级粗略延时
extern void F_SYSTEM_Time(void);	            //产生系统时间标志位
extern void F_RunTime_Calc(void);

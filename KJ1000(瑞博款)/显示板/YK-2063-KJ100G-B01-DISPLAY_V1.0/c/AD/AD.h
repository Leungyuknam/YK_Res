...
/******************ADC通道******************/
#define 		AIN0 			0x00		//< 选用AIN0为ADC的输入 >
#define 		AIN1 			0x01		//< 选用AIN1为ADC的输入 >
#define 		AIN2 			0x02		//< 选用AIN2为ADC的输入 >
#define 		AIN3 			0x03		//< 选用AIN3为ADC的输入 >
#define 		AIN4 			0x04		//< 选用AIN4为ADC的输入 >
#define 		AIN5 			0x05		//< 选用AIN5为ADC的输入 >
#define 		AIN6 			0x06		//< 选用AIN6为ADC的输入 >
#define 		AIN7 			0x07		//< 选用AIN7为ADC的输入 >
#define 		AIN8 			0x08		//< 选用AIN8为ADC的输入 >
#define 		AIN9 			0x09		//< 选用AIN9为ADC的输入 >
//#define 		AIN10 			0x0A		//< 选用AIN10为ADC的输入 >
//#define 		AIN11 			0x0B		//< 选用AIN11为ADC的输入 >
//#define 		AIN12 			0x0C		//< 选用AIN12为ADC的输入 >
//#define 		AIN13 			0x0D		//< 选用AIN13为ADC的输入 >
//#define 		AIN14 			0x0E		//< 选用AIN14为ADC的输入 >
//#define 		AIN15 			0x0F		//< 选用AIN15为ADC的输入 >
#define 		AIN_VDD_D4 		0x1F 		//< 选用1/4VDD为ADC的输入 >
...
/*****************************************************************/
#define c_GETAD_AVERAGE_TIMER   16 //读c_GETAD_AVERAGE_TIMER次后取一次平均 丢弃前三次
...
#define FIND_TABLE_ENABLE       0 //使用查表功能
...
//extern unsigned char F_GetAD(unsigned int ADCV, AD_Structure *AD_Str, unsigned int MaxValue, unsigned MinValue);

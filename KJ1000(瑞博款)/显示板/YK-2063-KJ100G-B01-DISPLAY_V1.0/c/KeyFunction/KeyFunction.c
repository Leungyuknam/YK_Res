...
//		}
//		
//		if(g_u8PowerOnDispTime)		//退出开机动画
//		{		
//				g_u8PowerOnDispTime = 0;
//			  F_BuzzerSet(BUZ_SHORT_2);
//				return 0;
//		}
		

        
//    if(!g_u8KeyDispTime && (LIGHT_OFF == g_u8LightState))
//    {
//        g_u8KeyDispTime = C_KEY_DISP_TIME;
//        g_u8SleepDispTime = C_KEY_DISP_TIME;
//        return 0;
//    }
//    if(!g_u8SleepDispTime && (MODE_SLEEP == g_u8WorkMode))
//    {
//        g_u8KeyDispTime = C_KEY_DISP_TIME;
//        g_u8SleepDispTime = C_KEY_DISP_TIME;
//        return 0;
...
//            if((g_u8WorkMode > MODE_HIGH) || (DIPS_FAN == F_GetDispType()))
//            {
//                if(++g_u8WorkMode > MODE_AI)
//                {   g_u8WorkMode = MODE_LOW;}
//            }
//            if(g_u8WorkMode <= MODE_HIGH)
//            {   F_DispTskChange(DIPS_FAN);}
//            else
//            {   F_DispTskChange(DIPS_NORMAL);}
            F_BuzzerSet(BUZ_SHORT);
        }
...
//				if(!g_u8TimeData 
//				|| (DIPS_TIME == F_GetDispType()) 
//				|| (!g_bTurnOn && !g_bScreenInitFlg))
//				{  
//						F_TimeType(g_u8TimeData+1);
//						g_u8TimeHBlinkTime = C_TIMEH_BLINK_TIME;
//				}
//				F_DispTskChange(DIPS_TIME);
//				F_BuzzerSet(BUZ_SHORT);
    }	
}
/**************************************************

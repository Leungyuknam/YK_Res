...
typedef signed char  	S8;//有符号字符型变量  8位数据：   -128~127
typedef signed int  	S16;//有符号整型变量    16位数据：  -32768~32767 
typedef signed long  	S32; //有符号长整型变量  32位数据    -2147483648---+2147483647
typedef signed char  	s8;//有符号字符型变量  8位数据：   -128~127
typedef signed int  	s16;//有符号整型变量    16位数据：  -32768~32767 
typedef signed long  	s32; //有符号长整型变量  32位数据    -2147483648---+2147483647
...
typedef U8   (*U8WithResertFan)(U8 DA);
typedef void (*U8U8Fan)(U8 DA ,U8 DB );
...
#define UnitWord(x,y)	(((uint)(x)<< 8)+(y))
...
#define		CtoF(x)		((((int)(x))*9)/5 +32)
#define		FtoC(x)		((((int)(x)) - 32)*5/9)
